...
(1, 'paypal', 'PayPal', 'paypal', 1, 'Paypal Email Address', 'Currency Code', 'Not in Use', 'admin@manimediaserver.com', 'CAD', '', 1, 1),
...
INSERT INTO `settings` (`id`, `company`, `site_email`, `psite_email`, `site_dir`, `reg_allowed`, `reg_verify`, `notify_admin`, `auto_verify`, `perpage`, `backup`, `logo`, `plogo`, `currency`, `enable_tax`, `long_date`, `short_date`, `time_format`, `dtz`, `locale`, `lang`, `weekstart`, `inv_info`, `inv_note`, `offline_info`, `social_media`, `mailer`, `smtp_host`, `smtp_user`, `smtp_pass`, `smtp_port`, `is_ssl`, `sendmail`, `wojon`, `wojov`) VALUES
(1, 'Membership Manager', '', '', '', 1, 1, 1, 1, 12, '20-Aug-2016_16-19-03.sql', 'logo.png', 'print_logo.png', 'CAD', 1, 'MMMM dd, yyyy hh:mm a', 'dd MMM yyyy', 'HH:mm', 'America/Toronto', 'en_CA', 'en', 0, '<p><b>ABC Company Pty Ltd</b><br />123 Burke Street, Toronto ON, CANADA<br />Tel : (416) 1234-5678, Fax : (416) 1234-5679, Email : sales@abc-company.com<br />Web Site : www.abc-company.com</p>', '<p>TERMS &amp; CONDITIONS<br />1. Interest may be levied on overdue accounts. <br />2. Goods sold are not returnable or refundable</p>', '<p>Instructions for offline payments...</p>', '{\"facebook\":\"facebook_page\",\"twitter\":\"twitter_page\"}', 'PHP', '', '', '', '0', 0, 'sendmail path', '1.00', '4.00');
