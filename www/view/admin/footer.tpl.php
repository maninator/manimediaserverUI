...
<!-- Footer -->
  ...
  <?php if (isset($display_copyright) && $display_copyright) { ?><footer> Copyright &copy;<?php echo date('Y') . ' '. $core->company;?> <i class="icon middle wojologo"></i> Powered by: MMP v <?php echo $core->wojov;?> </footer><?php } ?>
