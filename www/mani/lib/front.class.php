<?php
  ...
  class FrontController
  {
      ...
      /**
       * FrontController::Ajax()
       * 
       * @return
       */
      public function Ajax()
      {
		  // Let the Ajax class handle this:
      	  Ajax::query();
		  die();
      }

      /**
       * FrontController::Tvshows()
       * 
       * @return
       */
      public function Tvshows()
      {
          ...
          $tpl = App::View(BASEPATH . 'view/');
          $tpl->dir = "front/";
		  $tpl->data = Stats::userContent(App::Auth(), true, true);
		  $tpl->totals = Stats::userTotals();
          $tpl->template = 'front/tvshows.tpl.php';
          $tpl->title = Lang::$word->META_T34;
      }

      /**
       * FrontController::Movies()
       * 
       * @return
       */
      public function Movies()
      {
          ...
          $tpl = App::View(BASEPATH . 'view/');
          $tpl->dir = "front/";
		  $tpl->data = Stats::userContent(App::Auth(), true, true, "MOVIE");
		  $tpl->totals = Stats::userTotals();
          $tpl->template = 'front/movies.tpl.php';
